import React from 'react'; // FIX: was missing — component uses React.FC implicitly via JSX
      ...
      >
        ...
        >
          ...
          <p
            ...
            style={{ fontSize: '14px', lineHeight: '1.75', color: 'rgba(0, 0, 0, 0.55)', fontWeight: 300 }}
          >
